...
Main2Window *Main2Window::m_pSelf = 0l;
               ...
               QSettings::IniFormat, this)
{
    ...
    if (!backPath.isEmpty()) {
        // qDebug() << "Main2Window::readSettings" << backPath;
...
void Main2Window::closeEvent(QCloseEvent *event)
{
    if (!m_editor->close()) {
        event->ignore();
        return;
...
void Main2Window::writeSettings()
{
...
QString Main2Window::loc()
{
    return Circuit::self()->loc();
}

void Main2Window::setLoc(QString loc)
{
    Circuit::self()->setLoc(loc);
}

int Main2Window::autoBck()
{
    return m_autoBck;
}

void Main2Window::setAutoBck(int secs)
{
    m_autoBck = secs;
}

void Main2Window::setTitle(QString title)
{
    setWindowTitle(m_version + "  -  " + title);
}

void Main2Window::createWidgets()
{
...
QString *Main2Window::circHelp()
{
    return &m_circHelp;
}

void Main2Window::loadPlugins()
{
    // Load main Plugins
...
void Main2Window::loadPluginsAt(QDir pluginsDir)
{
...
void Main2Window::unLoadPugin(QString pluginName)
{
    if (m_plugins.contains(pluginName)) {
...
QSettings *Main2Window::settings()
{
    return &m_settings;
}
